...
# SET UP ENVIRONMENT
module load use.own
module load lqcd/gpu/gcc/9.1.1
module load lqcd/gpu/cmake/3.23.0
module load lqcd/gpu/cuda/11.5
module load lqcd/gpu/mpi/openmpi/4.1.3-ucx-cuda11.5-gcc9
module list 

export PK_CUDA_HOME=/usr/local/cuda-11.5
export PK_MPI_HOME=${MPI_ROOT}
export GCC_HOME=/opt/rh/devtoolset-9/root/usr/

SM=sm_80     # NVIDIA A100
OMP="yes"
